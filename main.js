...
module.exports = __webpack_require__.p + "f046eac26cc31c042050.png";
...
/* harmony import */ var _assets_icons8_cloud_96_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
logo.id = 'logo';
logo.src = _assets_icons8_cloud_96_png__WEBPACK_IMPORTED_MODULE_2__;
...
btnUpdateForecast.addEventListener('click', async () => {
    ...
    try {
        let weatherObj = await (0,_API__WEBPACK_IMPORTED_MODULE_1__.getWeather)(location);
